...
import { ArrowRight, Home as HomeIcon, Building, Hotel, DollarSign } from 'lucide-react';
  ...
  const services = [
    {
      ...
      description: 'Transform your residential spaces with our comprehensive home design services. From cozy living rooms to beautiful gardens.',
      icon: HomeIcon,
      link: '/services/home',
    ...
    },
    {
      ...
      description: 'Create memorable hospitality experiences with luxurious hotel interiors and impressive exterior designs.',
      icon: Hotel,
      link: '/services/hotel',
    ...
    },
    {
      ...
      description: 'Design productive and professional office environments that inspire creativity and enhance business success.',
      icon: Building,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We specialize in creating beautiful, functional spaces across residential, hospitality, and commercial sectors
            </p>
          </div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Discover some of our most stunning transformations across all service categories
            </p>
          </div>
                ...
                <div className="p-6">
                  ...
                  {image.price && (
                    <div className="flex items-center text-amber-600 font-semibold">
                      ...
                      <span className="text-lg">{image.price.toLocaleString()}</span>
                    </div>
                  )}
                </div>
              </div>
      ...
      <section className="py-20 bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
            Whether it's your home, hotel, or office - let's create something beautiful together.
          </p>
          <Link
            to="/contact"
            className="bg-gradient-to-r from-amber-600 to-orange-600 text-white px-8 py-4 rounded-lg text-lg font-semibold hover:from-amber-700 hover:to-orange-700 transform hover:scale-105 transition-all duration-200 inline-flex items-center space-x-2"
