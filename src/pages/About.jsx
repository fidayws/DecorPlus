...
export default function About() {
  ...
  const values = [
    ...
    },
    {
      ...
      description:
        "Your vision is our priority. We listen, understand, and deliver.",
    },
    {
      icon: Award,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center text-white">
            ...
            <p className="text-xl md:text-2xl max-w-4xl mx-auto leading-relaxed">
              For over 15 years, we've been transforming homes, hotels, and
              offices through exceptional design. Our passion is creating spaces
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-lg text-gray-600 leading-relaxed">
                <p>
                  Home Plus Interiors & Exteriors was founded on the belief that
                  "Change begins at home." We understand that your living space
                  is more than just a place to reside—it's where memories are
                  made, dreams are nurtured, and life unfolds.
                </p>
                <p>
                  Our journey began when our founders, Firdous Ahmed and Javaid
                  Ahmed, recognized the transformative power of thoughtful
                  design. What started as a small interior design studio has
                  grown into a full-service design firm specializing in
                  residential, hospitality, and commercial spaces.
                </p>
                <p>
                  Today, we're proud to have completed over 500 projects, each
                  one unique and tailored to our clients' specific needs and
                  dreams. Our team combines artistic vision with practical
                  expertise to create spaces that are both beautiful and
                  functional.
                </p>
              </div>
            </div>
      ...
      <section className="py-20 bg-gradient-to-r from-amber-600 to-orange-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-amber-100 mb-8 max-w-3xl mx-auto">
            Let's work together to transform your space into something
            extraordinary
          </p>
          <a
            href="/contact"
